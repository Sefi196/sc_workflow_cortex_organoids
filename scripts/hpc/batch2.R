...
#####fastq_files 
fastqs = c("/data/scratch/projects/punim1441/Project_cortex_organoid_LRsc/fastqs/org_1B.fastq.gz", "/data/scratch/projects/punim1441/Project_cortex_organoid_LRsc/fastqs/org_3B.fastq.gz") # or fastqs = c("sample1.fq", "sample2.fq")
output = "/data/scratch/projects/punim1441/Project_cortex_organoid_LRsc/outs/batch_4"
